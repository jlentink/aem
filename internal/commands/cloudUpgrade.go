...
func (c *cloudUpgrade) setup() *cobra.Command {
	cmd := &cobra.Command{
		Use:    "install",
...
func (c *cloudUpgrade) preRun(cmd *cobra.Command, args []string) {
...
func (c *cloudUpgrade) run(cmd *cobra.Command, args []string) {
